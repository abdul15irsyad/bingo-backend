...
func Init(r *gin.Engine) {
	...
	gameService := service.NewGameService(socketService)
	...
	gameHandler := handler.NewGameHandler(socketService, gameService)
	// route
	...
	gameRoute := routes.NewGameRoute(gameHandler)
